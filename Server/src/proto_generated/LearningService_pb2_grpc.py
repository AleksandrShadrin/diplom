...
from proto_generated import LearningService_pb2 as LearningService__pb2
...
class LearningServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetLearningModelsNames = channel.unary_unary(
            ...
            SerializeToString,
            response_deserializer=LearningService__pb2.LearningModelNames.
            FromString,
        )
        self.GetTrainedModels = channel.unary_unary(
            ...
            request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.
            SerializeToString,
            response_deserializer=LearningService__pb2.TrainedModels.
            FromString,
        )
        self.TrainModel = channel.unary_unary(
            ...
            response_deserializer=LearningService__pb2.TrainResponse.
            FromString,
        )
...
def add_LearningServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.
            FromString,
            response_serializer=LearningService__pb2.TrainedModels.
            SerializeToString,
        ),
        'TrainModel':
        grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=LearningService__pb2.TrainResponse.
            SerializeToString,
        ),
    }
...
class LearningService(object):
    ...
    def GetLearningModelsNames(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            LearningService__pb2.LearningModelNames.FromString, options,
    ...
    def GetTrainedModels(request,
                         ...
                         metadata=None):
        return grpc.experimental.unary_unary(
            request, target, '/learning.LearningService/GetTrainedModels',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            LearningService__pb2.TrainedModels.FromString, options,
            channel_credentials, insecure, call_credentials, compression,
            wait_for_ready, timeout, metadata)
    ...
    def TrainModel(request,
                   ...
                   metadata=None):
        return grpc.experimental.unary_unary(
            request, target, '/learning.LearningService/TrainModel',
            LearningService__pb2.Model.SerializeToString,
            LearningService__pb2.TrainResponse.FromString, options,
            channel_credentials, insecure, call_credentials, compression,
            wait_for_ready, timeout, metadata)
