...
from proto_generated import Health_pb2 as Health__pb2
...
class HealthStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Check = channel.unary_unary(
            '/health.Health/Check',
            request_serializer=Health__pb2.HealthCheckRequest.
            SerializeToString,
...
def add_HealthServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=Health__pb2.HealthCheckResponse.
            SerializeToString,
        ),
    }
...
class Health(object):
    ...
    def Check(request,
        ...
        return grpc.experimental.unary_unary(
            request, target, '/health.Health/Check',
            Health__pb2.HealthCheckRequest.SerializeToString,
            Health__pb2.HealthCheckResponse.FromString, options,
